...
### Six Major Steps in Developing a Forecast using
...
3.  What are the forecasted values of the Household Final Consumption Expenditure on Food for the years 2024 to 2026?
...
```{r}
ggplotly(autoplot(decompose(food_ts)))
food_ts_filtered=window(food_ts, end = c(2023, 4))
graph2=ggseasonplot(food_ts_filtered, year.labels=TRUE, main="Seasonal Plot",ylab="in million Php", continuous = TRUE)
ggplotly(graph2)
```
